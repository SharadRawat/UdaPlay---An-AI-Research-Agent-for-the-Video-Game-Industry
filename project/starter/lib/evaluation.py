...
class EvaluationReport(BaseModel):
    """Format for output evaluation."""
    useful: bool = Field(description="Whether the output is useful to answer the query.")
    description: str = Field(description="Detailed explanation of usefullness or unusefulness.")

    @validator('useful', pre=True)
    def parse_boolean_string(cls, v):
        if isinstance(v, str):
